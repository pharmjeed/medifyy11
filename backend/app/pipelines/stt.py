...
إعادة محاولة عابرة (قرار مالك 2026-08-03): أخطاء timeout/5xx تُعاد تلقائياً بـ exponential backoff
(30 ثانية → دقيقتين → 5 دقائق) دون تدخل بشري. أخطاء غير قابلة للإعادة (ملف تالف، صيغة غير مدعومة)
ترفع MDF-5031 فوراً.
"""
