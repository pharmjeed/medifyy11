...
/** التقاط صوت الميكروفون لتسجيل الزيارة (P1) — قرار مالك 2026-08-02: لا تفريغ أثناء التسجيل.
 *
 *  المخرج PCM16 أحادي بمعدل 16 kHz مُرمَّز base64 — الخادم يُلحقه بملف WAV الزيارة
 *  أولاً بأول، وبعد إنهاء المحادثة يُفرَّغ الملف كاملاً تمريرة واحدة مع تحديد المتحدث.
 *  الصوت لا يغادر المتصفح إلا عبر قناة الزيارة WSS.
 */
