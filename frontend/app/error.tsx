    ...
    <main style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ width: "min(470px,94vw)", background: "#fff", border: "1px solid #c7d1e0", borderRadius: 12, padding: 28, textAlign: "center" }}>
        ...
        <div style={{ marginTop: 10 }}>
          <bdi style={{ fontSize: 22, fontWeight: 700, color: "#d94b4b", fontFamily: "var(--m-mono)" }}>MDF-5001</bdi>
        </div>
        <h1 style={{ fontSize: 18, fontWeight: 700, color: "#005a55", margin: "6px 0" }}>{L("حدث خطأ غير متوقع", "An unexpected error occurred")}</h1>
        <p style={{ fontSize: 14, color: "#5c7096", margin: "8px 0 4px" }}>
        ...
        <p style={{ fontSize: 12.5, color: "#5c7096", margin: "0 0 16px" }}>
